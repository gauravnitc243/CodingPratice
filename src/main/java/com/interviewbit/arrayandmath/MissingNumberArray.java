...
public class MissingNumberArray {
	...
	public static ArrayList<Integer> repeatedNumber(final List<Integer> a)
	{
		...
		try
		{
			int n = a.size();
			long arraySum = 0l;
			long arraySquareSum = 0l;
			for(int i =0;i<a.size();i++)
			{
				arraySquareSum += a.get(i)*a.get(i);
				arraySum += a.get(i);
			}
			long sumOfN = (n*(n+1))/2;
			long sumOfSquareN = (sumOfN*((2*n)+1))/3;
			long squareDiff = sumOfSquareN - arraySquareSum;
			long diff = sumOfN -arraySum;
	...
	/*public static ArrayList<Integer> repeatedNumber(final List<Integer> a)
	{
		...
		java.math.BigInteger aa =new java.math.BigInteger(""+size).multiply(new java.math.BigInteger((size+1)+""));
		java.math.BigInteger bb = new  java.math.BigInteger((2*size+1)+"");
		java.math.BigInteger squareSum = (aa.multiply(bb)).divide(new java.math.BigInteger("6"));
		java.math.BigInteger sum = aa.divide(new java.math.BigInteger("2"));
		java.math.BigInteger arraySum =new java.math.BigInteger("0");
		java.math.BigInteger arraySquareSum = new java.math.BigInteger("0");
		for(int i : a)
		{
			arraySum = arraySum.add(new java.math.BigInteger(i+""));
			arraySquareSum =arraySquareSum.add(new java.math.BigInteger((i*i)+""));
		}
		
		long aLessB = sum.subtract(arraySum).longValue();
		long aSquareLessBSquare = squareSum.subtract(arraySquareSum).intValue();
		long aAddB = aSquareLessBSquare/aLessB;
		
		long first = (aLessB+ aAddB)/2;
		long second = aAddB-first;
...
/*	public static ArrayList<Integer> repeatedNumber(final List<Integer> a) 
	...
	/*public static ArrayList<Integer> repeatedNumber(final List<Integer> a)
	{
		...
		long sum = (a.size() * (a.size() + 1)) / 2;
		long missing =  (sum - arraySum + duplicate);
		result.add(duplicate);
